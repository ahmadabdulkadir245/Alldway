...
function SingleProduct() {
  ...
  const singleProduct = Properties.filter(
    (property) => property.id === productId
  );
  return (
    <div className='iceland mt-28'>
              ...
              >
                ...
                <div className='col-span-2 lg:col-span-1 py-2 px-4 lg:px-8 shadow-lg  bg-white'>
                  <div className='flex justify-between'>
                    <div>
                      <h4 className='text-lg text-gray-500 p-1'>{purchase}</h4>
                    </div>
                    <div>
                  ...
                  <div className='flex justify-between my-5'>
                    <div>
                      <h4 className='text-lg text-[#093158] p-1'>
                        PLOT: <span className='text-yellow-500'> {plot} </span>
                      </h4>
                    </div>
                    <div>
                      <h4 className='text-lg text-[#093158] p-1'>
                        PRICE: N<span className='text-yellow-500'>{price}</span>
                      </h4>
                    </div>
                  </div>
